...
От интеграции брокера сообщений решено отказаться, т.к. в стеке такое технологическое требование не указано явно, и для достижения необходимой нагрузоустойчивости достаточно написанного контроллера.
